      ...
      <>
         <ResizablePanelGroup direction='horizontal' className='h-screen w-screen'>
            <ResizablePanel
               ...
               maxSize={20}
               collapsible={true}
               className={cn('sm:hidden md:hidden', isCollapsed && 'min-w-[60px] transition-all duration-300 ease-in-out')}
               onExpand={() => setIsCollapsed(false)}
               onCollapse={() => setIsCollapsed(Boolean(true))}
            >
            ...
            <ResizablePanel defaultSize={1600} maxSize={1860}>
